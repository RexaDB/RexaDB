...
/** RexaDB built-in agent — the RexaDB agent mark */
export function RexaDBIcon({ className, ...props }: IconProps) {
  return (
    ...
    <img
      ...
      src="/ai-agent.png"
      alt="RexaDB Agent"
      className={cn("shrink-0 rounded-[3px] object-cover dark:invert", className)}
    />
  );
}

/** Claude AI — Anthropic's logo, terracotta fill */
...
/** OpenAI / Codex — black in light mode, white in dark mode */
...
/** OpenCode — dual-theme SVG (light/dark variants) */
...
/** Cursor — dark fill in light mode, light fill in dark mode */
...
/** fx (Vercel Labs) — official 𝒇x mark, white on black */
export function FxIcon({ className, ...props }: IconProps) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
    <img
      {...(props as React.ImgHTMLAttributes<HTMLImageElement>)}
      src="/providers/fx.png"
      alt="fx"
...
/** pi coding agent — from t3code's PiAgentIcon */
